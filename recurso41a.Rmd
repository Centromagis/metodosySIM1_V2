---
title: <span style="color:#686868"> **Importar**</span> 
...
<h2>Ciclo del análisis de datos</h2>
...
<center>
**Figura 1.31**  Ciclo del análisis de los datos.  <br/>
</center>
...
<h3>Utilizando el menú RStudio y un repositorio interno</h3>
...
<br/>
**Tabla 1.12**: Formatos de datos importados en **R**. 
...
<h3>Utilizando API y token desde un repositorio externo</h3>

Se puede importar una base de datos desde un repositorio que utilice **API** mediante un **token**. En este caso, es necesario solicitar el token correspondiente e instalar el paquete `RSocrata`.
</br>
...
# Dataset de velocidad y distancia de frenado de automóviles
data(cars)  

# Cargar un dataset desde un paquete 
#instalado (ejemplo: paqueteMETODOS)
...
<h3>Utilizando una función para determinar la ruta del archivo</h3>
...
<h3>Utilizando funciones de RStudio y un repositorio interno</h3>
