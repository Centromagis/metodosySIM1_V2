...
**Figura 1.29** Comparación de las formas de curtosis.
</center>
...
1. **Simétrica**:  
   ...
   \bar{x} = Me
   \]  
   Los datos están distribuidos de manera uniforme alrededor de la media.

2. **Asimétrica a la izquierda**: 
   ...
   \bar{x} < Me
   \]  
   Indica que la distribución tiene una cola más larga hacia la izquierda.

3. **Asimétrica a la derecha**:  
...
```
**Figura 1.30** Comparación de las formas de sesgo o asimetrías.
