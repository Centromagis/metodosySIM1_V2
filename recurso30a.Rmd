...
A continuación, se presenta la **Tabla 1.7** con los **tipos de gráficos** recomendados según el tipo de variable  junto con la sintaxis correspondiente en **R**.

<br/>

<center>
**Tabla 1.7** Tipos de gráficos según el tipo de variable.
</center>

<br/>


| **Tipo de variable** | **Tipos de escala**       | **Tipo de gráfico**           | **Sintaxis en R**         |
|:---------------------|:--------------------------|:------------------------------|:---------------------------|
| **Cualitativa**      | Nominal u ordinal         | Diagrama de torta             | `pie(table(x))`            |
|                      |                           | Diagrama de barras            | `barplot(table(x))`        |
|                      |                           | Diagrama de barras compuestas | `barplot(table(x, y))`     |
...
| **Tipo de variable** | **Tipo de gráfico**           | **Sintaxis en R**          |
|:---------------------|:------------------------------|:---------------------------|
| **Cuantitativa**     | Diagrama de tallos y hojas    | `stem(x)`                  |
|                      | Histograma                    | `hist(x)`                  |
|                      | Diagrama de densidad          | `plot(density(x))`         |
|                      | Diagrama de cajas             | `boxplot(x)`               |
|                      | Diagrama de dispersión            | `plot(x, y)`               |
|                      | Diagrama de línea (*series*)  | `plot(x, type = "l")`      |
